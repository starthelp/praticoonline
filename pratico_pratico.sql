...
--
-- Host: localhost
-- Generation Time: 02-Maio-2017 às 09:06
...
INSERT INTO `cargos` (`id`, `cbo`, `descricao`) VALUES
(1, '516210', 'Acomp. Idosos'),
(2, '012110', 'Arrumadeira'),
(3, '251605', 'Assistente Doméstico'),
(4, '540205', 'Assistente Pessoal'),
(5, '516205', 'Babá'),
(6, '512105', 'Caseiro'),
(7, '513210', 'Cozinheira'),
(8, '516210', 'Cuidador de Criança'),
(9, '516210', 'Dama de Companhia'),
(10, '512105', 'Empregada Doméstica'),
(11, '223505', 'Enfermeira'),
(12, '512105', 'Faxineira'),
(13, '513405', 'Garçom'),
(14, '513105', 'Governanta'),
(15, '622010', 'Jardineiro'),
(16, '516305', 'Lavadeira'),
(17, '782725', 'Marinheiro'),
(18, '782715', 'Moço de Convés'),
(19, '513105', 'Mordomo'),
(20, '782305', 'Motorista'),
(21, '516325', 'Passadeira'),
(22, '041350', 'Piloto'),
(23, '517420', 'Vigia');
...
--
-- Estrutura da tabela `categoriatrabalhador`
--

CREATE TABLE IF NOT EXISTS `categoriatrabalhador` (
  `id` int(11) NOT NULL,
...
--
-- Extraindo dados da tabela `categoriatrabalhador`
--

INSERT INTO `categoriatrabalhador` (`id`, `descricao`, `grupo`) VALUES
(101, 'Empregado – Geral', 'Empregado\r'),
(102, 'Empregado – Trabalhador Rural por Pequeno Prazo da Lei 11.718/2008', 'Empregado\r'),
(103, 'Empregado – Aprendiz', 'Empregado\r'),
(104, 'Empregado – Doméstico', 'Empregado\r'),
(105, 'Empregado – contrato a termo firmado nos termos da Lei 9601/98', 'Empregado\r'),
(106, 'Empregado – contrato por prazo determinado nos termos da Lei 6019/74', 'Empregado\r'),
(107, 'Trabalhador não vinculado ao RGPS com direito ao FGTS', 'Empregado\r'),
(201, 'Trabalhador Avulso – Portuário', 'Trabalhador Avulso\r'),
(202, 'Trabalhador Avulso – Não Portuário (Informação do Sindicato)', 'Trabalhador Avulso\r'),
(203, 'Trabalhador Avulso – Não Portuário (Informação do Contratante)', 'Trabalhador Avulso\r'),
(301, 'Servidor Público – Titular de Cargo Efetivo', 'Servidor Público\r'),
(302, 'Servidor Público – Ocupante de Cargo exclusivo em comissão', 'Servidor Público\r'),
(303, 'Servidor Público – Exercente de Mandato Eletivo', 'Servidor Público\r'),
(304, 'Servidor Público – Agente Público', 'Servidor Público\r'),
(305, 'Servidor Público vinculado a RPPS indicado para conselho ou órgão representativo, na condição de representante do governo, órgão ou entidade da administração pública.', 'Servidor Público\r'),
(306, 'Servidor Público –  Contrato Temporário', 'Servidor Público\r'),
(401, 'Dirigente Sindical – Em relação a Remuneração Recebida no Sindicato.', 'Dirigente Sindical\r'),
(701, 'Contribuinte individual – Autônomo contratado por Empresas em geral', 'Contribuinte individual\r'),
(702, 'Contribuinte individual – Autônomo contratado por Contribuinte individual, por pessoa física em geral, ou por missão diplomática e repartição consular de carreira estrangeiras', 'Contribuinte individual\r'),
(703, 'Contribuinte individual – Autônomo contratado por Entidade Beneficente de Assistência Social isenta da cota patronal', 'Contribuinte individual\r'),
(711, 'Contribuinte individual – Transportador autônomo contratado por Empresas em geral', 'Contribuinte individual\r'),
(712, 'Contribuinte individual – Transportador autônomo contratado por Contribuinte individual, por pessoa física em geral, ou por missão diplomática e repartição consular de carreira estrangeiras', 'Contribuinte individual\r'),
(713, 'Contribuinte individual – Transportador autônomo contratado por Entidade Beneficente de Assistência Social isenta da cota patronal', 'Contribuinte individual\r'),
(721, 'Contribuinte individual – Diretor não empregado com FGTS', 'Contribuinte individual\r'),
(722, 'Contribuinte individual – Diretor não empregado sem FGTS', 'Contribuinte individual\r'),
(731, 'Contribuinte individual – Cooperado que presta serviços a empresa por intermédio de cooperativa de trabalho', 'Contribuinte individual\r'),
(732, 'Contribuinte individual – Cooperado que presta serviços a Entidade Beneficente de Assistência Social isenta da cota patronal ou para pessoa física', 'Contribuinte individual\r'),
(733, 'Contribuinte individual – Cooperado eleito para direção da Cooperativa', 'Contribuinte individual\r'),
(734, 'Contribuinte individual – Transportador Cooperado que presta serviços a empresa por intermédio de cooperativa de trabalho', 'Contribuinte individual\r'),
(735, 'Contribuinte individual – Transportador Cooperado que presta serviços a Entidade Beneficente de Assistência Social isenta da cota patronal ou para pessoa física', 'Contribuinte individual\r'),
(736, 'Contribuinte individual – Transportador Cooperado eleito para direção da Cooperativa', 'Contribuinte individual\r'),
(741, 'Contribuinte individual – Cooperado filiado a cooperativa de produção', 'Contribuinte individual\r'),
(751, 'Contribuinte individual – Micro Empreendedor Individual, quando contratado por PJ', 'Contribuinte individual\r'),
(901, 'Estagiário', 'Estagiário\r');
...
CREATE TABLE IF NOT EXISTS `colaboradores` (
  ...
  `paisnascimento` int(11) NOT NULL,
  `paisnacionalidade` int(11) NOT NULL,
  `ufnascimento` char(2) DEFAULT NULL,
  `municipionascimento` int(11) DEFAULT NULL,
  `primeiroemprego` char(3) NOT NULL,
  `nis` char(11) DEFAULT NULL,
  `idraca` int(11) NOT NULL,
  `idestadocivil` int(11) NOT NULL,
  `idgrauinstrucao` int(11) DEFAULT NULL,
  `ctps` char(11) DEFAULT NULL,
  `seriectps` char(4) DEFAULT NULL,
  `ufctps` char(2) DEFAULT NULL,
  `aposentado` char(1) DEFAULT NULL,
  `telefone` char(12) DEFAULT NULL,
  `email` varchar(60) DEFAULT NULL,
  `cep` varchar(8) DEFAULT NULL,
  `tipologradouro` varchar(5) DEFAULT NULL,
...
INSERT INTO `colaboradores` (`cpf`, `nome`, `nascimento`, `sexo`, `paisnascimento`, `paisnacionalidade`, `ufnascimento`, `municipionascimento`, `primeiroemprego`, `nis`, `idraca`, `idestadocivil`, `idgrauinstrucao`, `ctps`, `seriectps`, `ufctps`, `aposentado`, `telefone`, `email`, `cep`, `tipologradouro`, `logradouro`, `numlogradouro`, `complemento`, `bairro`, `idmunicipio`, `uf`, `idcategoria`) VALUES
('11111111111', 'MARIA', '0000-00-00', 'M', 13, 13, 'AC', 4100103, 'N', '', 1, 1, 1, '', '', NULL, 'N', '', '', '', NULL, '', '', '', '', 4100103, 'AC', NULL),
('12', 'JOANA MARIA ABDAL', '1999-11-30', 'M', 13, 13, 'AC', 4100103, 'N', '', 1, 1, 1, '', '', NULL, 'N', '', '', '', NULL, '', '', '', '', 4100103, 'AC', NULL),
('2222222222', 'MARIA', '0000-00-00', 'M', 13, 13, 'AC', 4100103, 'N', '', 1, 1, 1, '', '', NULL, 'N', '', '', '', NULL, '', '', '', '', 4100103, 'AC', NULL);
...
CREATE TABLE IF NOT EXISTS `contrato` (
  `cpfempregador` char(11) NOT NULL,
  `cpfcolaborador` char(11) NOT NULL,
  `admissao` date DEFAULT NULL,
  `tipo` char(1) DEFAULT NULL,
  `idcargo` int(11) NOT NULL,
  `salario` decimal(12,2) DEFAULT NULL,
  `unidadepagamento` char(1) DEFAULT NULL,
  `fgtsantes2015` char(1) DEFAULT NULL,
  `fgtsinicio` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `contrato` (`cpfempregador`, `cpfcolaborador`, `admissao`, `tipo`, `idcargo`, `salario`, `unidadepagamento`, `fgtsantes2015`, `fgtsinicio`) VALUES
('71856102904', '12', '1999-11-30', '1', 0, '0.00', '1', 'S', '1999-11-30');
...
CREATE TABLE IF NOT EXISTS `dependentes` (
  ...
  `nome` varchar(60) NOT NULL,
  `nascimento` date DEFAULT NULL,
  `deducaoirrf` char(1) DEFAULT NULL,
  `deducaosalariofamaila` char(1) DEFAULT NULL,
  `idtipodependencia` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `dependentes` (`sequencia`, `cpf`, `cpfcolaborador`, `nome`, `nascimento`, `deducaoirrf`, `deducaosalariofamaila`, `idtipodependencia`) VALUES
(1, '', '12', 'MATHEUS DE OLIVEIRA', '1993-07-19', 'N', 'N', 1);

--
-- Acionadores `dependentes`
--
DELIMITER $$
CREATE TRIGGER `dependentes_novasequencia` BEFORE INSERT ON `dependentes`
 FOR EACH ROW BEGIN
  declare novaseq integer;
  select ifnull(max(sequencia), 0) into novaseq from dependentes where cpfcolaborador = new.cpfcolaborador;
  set new.sequencia  = novaseq + 1;
END
$$
DELIMITER ;
...
CREATE TABLE IF NOT EXISTS `empregadores` (
  ...
  `irrfrecibo` varchar(20) DEFAULT NULL,
  `senha` varchar(35) NOT NULL,
  `telefone` varchar(20) DEFAULT NULL,
  `celular` varchar(20) DEFAULT NULL,
  `codacessoesocial` varchar(20) DEFAULT NULL,
  `email` text,
  ...
  `idclasstributaria` int(11) DEFAULT NULL,
  `iddesoneracaofolha` int(11) DEFAULT NULL,
  `idregeleempregados` int(11) DEFAULT NULL,
  `idindsitpessoafisica` int(11) DEFAULT NULL,
  `multiplastabrubicas` tinyint(1) DEFAULT NULL,
  `cep` varchar(8) DEFAULT NULL,
...
INSERT INTO `empregadores` (`id`, `nome`, `cpf`, `nascimento`, `tituloeleitor`, `irrfrecibo`, `senha`, `telefone`, `celular`, `codacessoesocial`, `email`, `ativo`, `idsituacao`, `cadastro`, `alteracao`, `ultacesso`, `idclasstributaria`, `iddesoneracaofolha`, `idregeleempregados`, `idindsitpessoafisica`, `multiplastabrubicas`, `cep`, `tipologradouro`, `logradouro`, `numlogradouro`, `complemento`, `bairro`, `idmunicipio`, `uf`) VALUES
(1, 'JOHNY RUBENS DE OLIVEIRA', '71856102904', '1970-01-01', '', '', 'e10adc3949ba59abbe56e057f20f883e', '', '4288271137', NULL, 'johnyrubens@gmail.com', 1, NULL, '2016-02-15 10:42:14', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '89400000', 'R', 'GETULIO DI', '554', 'CASA', 'SÃO PEDRO', 4213609, 'SC'),
(2, 'andrew palmeira', '67750842500', '1992-01-01', '', '', 'b68670f49f69f531f5d8cf5b42b343ee', '', '', NULL, 'andrew@starthelp.com.br', 1, NULL, '2016-02-15 11:27:05', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'Gabriel Schier', '09253760940', '1970-01-01', '', '', '21733be865c41d5d1bc1dcdccefa90c4', '', '', NULL, 'enggabrielschier@gmail.com', 0, NULL, '2016-02-15 18:38:26', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'andrew palmeira 2', '07590499986', '1970-01-01', '', '', 'b68670f49f69f531f5d8cf5b42b343ee', '', '', NULL, 'andrew@andrew.com.br', 0, NULL, '2016-02-16 02:43:20', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `empregador_colaboradores`
--

CREATE TABLE IF NOT EXISTS `empregador_colaboradores` (
  `id` int(10) unsigned NOT NULL,
  `cpfempregador` char(11) NOT NULL,
  `cpfcolaborador` char(11) NOT NULL,
...
('BA', 'Bahia\r'),
('CE', 'Ceará\r'),
('DF', 'Distrito Federal\r'),
('ES', 'Espírito Santo\r'),
('GO', 'Goiás\r'),
('MA', 'Maranhão\r'),
('MG', 'Minas Gerais\r'),
('MS', 'Mato Grosso do Sul\r'),
('MT', 'Mato Grosso\r'),
('PA', 'Pará\r'),
('PB', 'Paraíba\r'),
('PE', 'Pernambuco\r'),
...
('PR', 'Paraná\r'),
('RJ', 'Rio de Janeiro\r'),
('RN', 'Rio Grande do Norte\r'),
('RO', 'Rondônia\r'),
('RR', 'Roraima\r'),
('RS', 'Rio Grande do Sul\r'),
('SC', 'Santa Catarina\r'),
('SE', 'Sergipe\r'),
('SP', 'São Paulo\r'),
('TO', 'Tocantins\r');
...
--
-- Estrutura da tabela `grauinstrucao`
--
...
--
-- Extraindo dados da tabela `grauinstrucao`
--

INSERT INTO `grauinstrucao` (`id`, `descricao`) VALUES
(1, 'Analfabeto'),
(2, 'Até a 4ª série incompleta do ensino fundamental (antigo 1º grau ou primário), ou que tenha se alfabetizado sem ter frequentado escola regular.'),
(3, '4ª séria completa do ensino fundamental (antigo 1º grau ou primário)'),
(4, 'Da 5ª a 8ª série do ensino fundamental (antigo 1º grau ou ginásio)'),
(5, 'Ensino fundamental completo (antigo 1º grau, primário ou ginásio)'),
...
CREATE TABLE IF NOT EXISTS `jornada_trabalho` (
  `cpfempregador` char(11) NOT NULL,
  `cpfcolaborador` char(11) NOT NULL,
  `seqfolga` tinyint(1) DEFAULT '0',
  `seginicio` time DEFAULT NULL,
  `segfinal` time DEFAULT NULL,
  `segintervalo` time DEFAULT NULL,
  `terfolga` tinyint(1) DEFAULT '0',
  `terinicio` time DEFAULT NULL,
  `terfinal` time DEFAULT NULL,
  `terintervalo` time DEFAULT NULL,
  `quafolga` tinyint(1) DEFAULT '0',
  `quainicio` time DEFAULT NULL,
  `quafinal` time DEFAULT NULL,
  `quaintervalo` time DEFAULT NULL,
  `quifolga` tinyint(1) DEFAULT '0',
  `quiinicio` time DEFAULT NULL,
  `quifinal` time DEFAULT NULL,
  `quiintervalo` time DEFAULT NULL,
  `sexfolga` tinyint(1) DEFAULT '0',
  `sexinicio` time DEFAULT NULL,
  `sexfinal` time DEFAULT NULL,
  `sexintervalo` time DEFAULT NULL,
  `sabfolga` tinyint(1) DEFAULT '0',
  `sabinicio` time DEFAULT NULL,
  `sabfinal` time DEFAULT NULL,
  `sabintervalo` time DEFAULT NULL,
  `domfolga` tinyint(1) DEFAULT '0',
  `dominicio` time DEFAULT NULL,
  `domfinal` time DEFAULT NULL,
  `domintervalo` time DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `jornada_trabalho` (`cpfempregador`, `cpfcolaborador`, `seqfolga`, `seginicio`, `segfinal`, `segintervalo`, `terfolga`, `terinicio`, `terfinal`, `terintervalo`, `quafolga`, `quainicio`, `quafinal`, `quaintervalo`, `quifolga`, `quiinicio`, `quifinal`, `quiintervalo`, `sexfolga`, `sexinicio`, `sexfinal`, `sexintervalo`, `sabfolga`, `sabinicio`, `sabfinal`, `sabintervalo`, `domfolga`, `dominicio`, `domfinal`, `domintervalo`) VALUES
('71856102904', '12', NULL, '00:00:00', '00:00:00', '00:00:00', 0, '00:00:00', '00:00:00', '00:00:00', 0, '00:00:00', '00:00:00', '00:00:00', 0, '00:00:00', '00:00:00', '00:00:00', 0, '00:00:00', '00:00:00', '00:00:00', 0, '00:00:00', '00:00:00', '00:00:00', 0, '00:00:00', '00:00:00', '00:00:00');

-- --------------------------------------------------------

--
-- Estrutura da tabela `jornada_trabalho2`
--

CREATE TABLE IF NOT EXISTS `jornada_trabalho2` (
  `cpfempregador` char(11) NOT NULL,
  `cpfcolaborador` char(11) NOT NULL,
  `diasemana` int(11) NOT NULL DEFAULT '0',
...
--
-- Extraindo dados da tabela `jornada_trabalho2`
--

INSERT INTO `jornada_trabalho2` (`cpfempregador`, `cpfcolaborador`, `diasemana`, `folga`, `inicio`, `final`, `intervalo`) VALUES
('71856102904', '12', 1, 0, '08:00:00', '18:00:00', '01:30:00'),
('71856102904', '12', 2, 1, '00:00:00', '00:00:00', '00:00:00'),
('71856102904', '12', 3, 1, '00:00:00', '00:00:00', '00:00:00'),
('71856102904', '12', 4, 1, '00:00:00', '00:00:00', '00:00:00'),
('71856102904', '12', 5, 1, '00:00:00', '00:00:00', '00:00:00'),
('71856102904', '12', 6, 1, '00:00:00', '00:00:00', '00:00:00'),
('71856102904', '12', 7, 1, '00:00:00', '00:00:00', '00:00:00');

-- --------------------------------------------------------

--
-- Estrutura da tabela `local_trabalho`
--
...
CREATE TABLE IF NOT EXISTS `local_trabalho` (
  ...
  `idmunicipio` int(11) DEFAULT NULL,
  `uf` char(2) DEFAULT NULL,
  `localmesmoempregador` char(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `local_trabalho`
--

INSERT INTO `local_trabalho` (`cpfempregador`, `cpfcolaborador`, `cep`, `tipologradouro`, `logradouro`, `numlogradouro`, `complemento`, `bairro`, `idmunicipio`, `uf`, `localmesmoempregador`) VALUES
('71856102904', '12', '', NULL, '', '', '', '', 4100103, 'AC', '1');
...
INSERT INTO `municipios` (`id`, `nome`, `estado`) VALUES
...
(13, 'Afeganistão\r'),
(17, 'Albânia, República da\r'),
(23, 'Alemanha\r'),
(31, 'Burkina Faso\r'),
(37, 'Andorra\r'),
(40, 'Angola\r'),
(41, 'Anguilla\r'),
(43, 'Antigua E Barbuda\r'),
(47, 'Antilhas Holandesas\r'),
(53, 'Arábia Saudita\r'),
(59, 'Argélia\r'),
(63, 'Argentina\r'),
(64, 'Armênia, República da\r'),
(65, 'Aruba\r'),
(69, 'Austrália\r'),
(72, 'Áustria\r'),
(73, 'Azerbaijão, República do\r'),
(77, 'Bahamas, Ilhas\r'),
(80, 'Bahrein, Ilhas\r'),
(81, 'Bangladesh\r'),
(83, 'Barbados\r'),
(85, 'Belarus, República da\r'),
(87, 'Bélgica\r'),
(88, 'Belize\r'),
(90, 'Bermudas\r'),
(93, 'Mianmar (Birmânia)\r'),
(97, 'Bolívia\r'),
(98, 'Bosnia-Herzegovina (República da)\r'),
(101, 'Botsuana\r'),
(105, 'Brasil\r'),
(108, 'Brunei\r'),
(111, 'Bulgária, República da\r'),
(115, 'Burundi\r'),
(119, 'Butão\r'),
(127, 'Cabo Verde, República de\r'),
(137, 'Cayman, Ilhas\r'),
(141, 'Camboja\r'),
(145, 'Camarões\r'),
(149, 'Canadá\r'),
(150, 'Jersey, Ilha do Canal\r'),
(151, 'Canárias, Ilhas\r'),
(153, 'Cazaquistao, República do\r'),
(154, 'Catar\r'),
(158, 'Chile\r'),
(160, 'China, República Popular\r'),
(161, 'Formosa (Taiwan)\r'),
(163, 'Chipre\r'),
(165, 'Cocos-Keeling, Ilhas\r'),
(169, 'Colômbia\r'),
(173, 'Comores, Ilhas\r'),
(177, 'Congo\r'),
(183, 'Cook, Ilhas\r'),
(187, 'Coréia, Rep.Pop.Democrática\r'),
(190, 'Coréia, República da\r'),
(193, 'Costa do Marfim\r'),
(195, 'Croácia, República da\r'),
(196, 'Costa Rica\r'),
(198, 'Coveite\r'),
(199, 'Cuba\r'),
(229, 'Benin\r'),
...
(240, 'Egito\r'),
(243, 'Eritreia\r'),
(244, 'Emirados Árabes Unidos\r'),
(245, 'Espanha\r'),
(246, 'Eslovênia, República da\r'),
(247, 'Eslovaca, República\r'),
(249, 'Estados Unidos\r'),
(251, 'Estônia, República da\r'),
(253, 'Etiópia\r'),
(255, 'Falkland (Ilhas Malvinas)\r'),
(259, 'Feroe, Ilhas\r'),
(267, 'Filipinas\r'),
(271, 'Finlândia\r'),
(275, 'França\r'),
...
(313, 'Guam\r'),
(317, 'Guatemala\r'),
(325, 'Guiana Francesa\r'),
(329, 'Guiné\r'),
(331, 'Guiné-Equatorial\r'),
(334, 'Guiné-Bissau\r'),
(337, 'Guiana\r'),
(341, 'Haiti\r'),
(345, 'Honduras\r'),
(351, 'Hong Kong\r'),
(355, 'Hungria, República da\r'),
(357, 'Iemen\r'),
(359, 'Man, Ilha de\r'),
(361, 'Índia\r'),
(365, 'Indonésia\r'),
(369, 'Iraque\r'),
(372, 'Irã,  República  Islâmica do\r'),
(375, 'Irlanda\r'),
(379, 'Islândia\r'),
(383, 'Israel\r'),
(386, 'Itália\r'),
(391, 'Jamaica\r'),
(396, 'Johnston, Ilhas\r'),
(399, 'Japão\r'),
(403, 'Jordânia\r'),
(411, 'Kiribati\r'),
(420, 'Laos, Rep.Pop.Democr.do\r'),
(423, 'Lebuan, Ilhas\r'),
(426, 'Lesoto\r'),
(427, 'Letônia, República da\r'),
(431, 'Líbano\r'),
(434, 'Libéria\r'),
(438, 'Líbia\r'),
(440, 'Liechtenstein\r'),
(442, 'Lituânia, República da\r'),
(445, 'Luxemburgo\r'),
(447, 'Macau\r'),
(449, 'Macedônia, Ant.Rep.Iugoslava\r'),
(450, 'Madagascar\r'),
(452, 'Madeira, Ilha da\r'),
(455, 'Malásia\r'),
(458, 'Malavi\r'),
(461, 'Maldivas\r'),
(464, 'Mali\r'),
(467, 'Malta\r'),
(472, 'Marianas do Norte\r'),
(474, 'Marrocos\r'),
(476, 'Marshall, Ilhas\r'),
(477, 'Martinica\r'),
(485, 'Maurício\r'),
(488, 'Mauritânia\r'),
(490, 'Midway, Ilhas\r'),
(493, 'México\r'),
(494, 'Moldavia, República da\r'),
(495, 'Mônaco\r'),
(497, 'Mongólia\r'),
(498, 'Montenegro\r'),
(499, 'Micronésia\r'),
(501, 'Montserrat, Ilhas\r'),
(505, 'Moçambique\r'),
(507, 'Namíbia\r'),
(508, 'Nauru\r'),
(511, 'Christmas,Ilhas (Navidad)\r'),
(517, 'Nepal\r'),
(521, 'Nicarágua\r'),
(525, 'Niger\r'),
(528, 'Nigéria\r'),
...
(535, 'Norfolk, Ilha\r'),
(538, 'Noruega\r'),
(542, 'Nova Caledônia\r'),
(545, 'Papua Nova Guiné\r'),
(548, 'Nova Zelândia\r'),
(551, 'Vanuatu\r'),
(556, 'Omã\r'),
(566, 'Pacífico, Ilhas do (possessão dos EUA)\r'),
(573, 'Países Baixos (Holanda)\r'),
(575, 'Palau\r'),
(576, 'Paquistão\r'),
(580, 'Panamá\r'),
(586, 'Paraguai\r'),
(589, 'Peru\r'),
(593, 'Pitcairn, Ilha De\r'),
(599, 'Polinésia Francesa\r'),
(603, 'Polônia, República da\r'),
(607, 'Portugal\r'),
(611, 'Porto Rico\r'),
(623, 'Quênia\r'),
(625, 'Quirguiz, República da\r'),
(628, 'Reino Unido\r'),
(640, 'República Centro- Africana\r'),
(647, 'República Dominicana\r'),
(660, 'Reunião, Ilha\r'),
(665, 'Zimbabue\r'),
(670, 'Romênia\r'),
(675, 'Ruanda\r'),
(676, 'Rússia, Federação da\r'),
(677, 'Salomão, Ilhas\r'),
(678, 'Saint Kitts e Nevis\r'),
(685, 'Saara Ocidental\r'),
(687, 'El Salvador\r'),
(690, 'Samoa\r'),
(691, 'Samoa Americana\r'),
(695, 'São  Cristovão e  Neves, Ilhas\r'),
(697, 'San Marino\r'),
(700, 'São Pedro e Miquelon\r'),
(705, 'São Vicente e Granadinas\r'),
(710, 'Santa Helena\r'),
(715, 'Santa Lúcia\r'),
(720, 'São   Tomé   e   Príncipe, Ilhas\r'),
(728, 'Senegal\r'),
(731, 'Seychelles\r'),
(735, 'Serra Leoa\r'),
(737, 'Servia\r'),
(741, 'Cingapura\r'),
(744, 'Síria,  República  Árabe da\r'),
(748, 'Somália\r'),
(750, 'Sri Lanka\r'),
(754, 'Suazilândia\r'),
(756, 'África do Sul\r'),
...
(767, 'Suíça\r'),
(770, 'Suriname\r'),
(772, 'Tadjiquistão, República do\r'),
(776, 'Tailândia\r'),
(780, 'Tanzania, Rep. Unida da\r'),
(782, 'Território   Britânico   no Oceano Índico\r'),
(783, 'Djibuti\r'),
(788, 'Chade\r'),
(791, 'Tcheca, República\r'),
(795, 'Timor Leste\r'),
(800, 'Togo\r'),
(805, 'Toquelau, Ilhas\r'),
(810, 'Tonga\r'),
(815, 'Trinidad e Tobago\r'),
(820, 'Tunísia\r'),
(823, 'Turcas e Caicos, Ilhas\r'),
(824, 'Turcomenistão, República do\r'),
(827, 'Turquia\r'),
(828, 'Tuvalu\r'),
(831, 'Ucrânia\r'),
(833, 'Uganda\r'),
(845, 'Uruguai\r'),
(847, 'Uzbequistão, República do\r'),
(848, 'Vaticano, Est. da Cidade do\r'),
(850, 'Venezuela\r'),
(858, 'Vietnã\r'),
(863, 'Virgens, Ilhas (Britânicas)\r'),
(866, 'Virgens, Ilhas (E.U.A.)\r'),
(870, 'Fiji\r'),
(873, 'Wake, Ilha\r'),
(875, 'Wallis e Futuna, Ilhas\r'),
(888, 'Congo, República Democrática do\r'),
(890, 'Zâmbia\r'),
(998, 'Delegação   Especial   da Palestina\r');
...
CREATE TABLE IF NOT EXISTS `plano` (
  ...
  `maxempregados` int(10) DEFAULT NULL,
  `ativo` char(3) NOT NULL DEFAULT 'Sim',
  `prazomin` smallint(6) DEFAULT NULL
...
INSERT INTO `plano` (`id`, `titulo`, `descricao`, `valor`, `maxempregados`, `ativo`, `prazomin`) VALUES
(15, 'TESTE', 'TESTE', '0.00', 1, 'Sim', 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `racacor`
--
...
--
-- Extraindo dados da tabela `racacor`
--

INSERT INTO `racacor` (`id`, `descricao`) VALUES
(1, 'Indígena'),
(2, 'Branca'),
(4, 'Negra'),
(6, 'Amarela (de origem japonesa, chinesa, coreana etc)'),
(8, 'Parda (parda ou declarada como mulata, cabocla, cafuza, mameluca ou mestiça de negro com pessoa de outra cor ou raça)'),
(9, 'Não informado');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tipodependente`
--

CREATE TABLE IF NOT EXISTS `tipodependente` (
  `id` int(11) NOT NULL,
  `descricao` varchar(150) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tipodependente`
--

INSERT INTO `tipodependente` (`id`, `descricao`) VALUES
(1, 'Cônjuge ou companheiro(a) com o(a) qual tenha filho ou viva há mais de 5 (cinco) anos.'),
...
(6, 'Irmão(ã), neto(a) ou bisneto(a) sem arrimo dos pais, com idade até 24 anos, se ainda estiver cursando estabelecimento de nível superior ou escola técn'),
(7, 'Irmão(ã), neto(a) ou bisneto(a) sem arrimo dos pais, do(a) qual detenha a guarda judicial, em qualquer idade, quando incapacitado física e/ou mentalme'),
(8, 'Pais, avós e bisavós.'),
(9, 'Menor pobre, até 21 (vinte e um) anos, que crie e eduque e do qual detenha a guarda judicial.'),
...
INSERT INTO `tipologradouro` (`id`, `nome`) VALUES
('A', 'Área\r'),
('AER', 'Aeroporto\r'),
('AL', 'Alameda\r'),
('AV', 'Avenida\r'),
...
(1, 'administrador', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@pratico@com.br');
...
--
-- Indexes for table `categoriatrabalhador`
--
...
ALTER TABLE `contrato`
  ADD PRIMARY KEY (`cpfempregador`,`cpfcolaborador`);

--
-- Indexes for table `dependentes`
--
ALTER TABLE `dependentes`
  ADD PRIMARY KEY (`sequencia`,`cpf`,`cpfcolaborador`);
...
--
-- Indexes for table `empregador_colaboradores`
--
ALTER TABLE `empregador_colaboradores`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `grauinstrucao`
--
...
--
-- Indexes for table `jornada_trabalho2`
--
ALTER TABLE `jornada_trabalho2`
  ADD PRIMARY KEY (`cpfempregador`,`cpfcolaborador`,`diasemana`);

--
-- Indexes for table `local_trabalho`
--
...
--
-- Indexes for table `racacor`
--
ALTER TABLE `racacor`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tipodependente`
--
ALTER TABLE `tipodependente`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `empregadores`
--
ALTER TABLE `empregadores`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `empregador_colaboradores`
--
ALTER TABLE `empregador_colaboradores`
